    ...
    <div className="max-w-6xl mx-auto py-6 px-4">
      ...
      {!isLoading && scenarios.length === 0 && !error && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <p className="text-gray-700 text-lg font-medium mb-2">No scenarios yet</p>
          <p className="text-gray-600 text-sm mb-6">
            Create your first scenario, or configure sample data first.
          </p>
            ...
            <div className="space-y-4">
                  ...
                  {TYPES.map((t) => (
                    <label key={t.value} className="flex items-start gap-3 cursor-pointer">
                      <input
                        ...
                        className="mt-0.5 border-gray-500 accent-gray-900 focus:ring-2 focus:ring-gray-500"
                      />
                      <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-lg border border-gray-500 bg-white px-3 py-2 text-sm text-gray-950 placeholder:text-gray-600 focus:border-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="mt-1 w-full resize-none rounded-lg border border-gray-500 bg-white px-3 py-2 text-sm text-gray-950 placeholder:text-gray-600 focus:border-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500"
                />
              </div>
            </div>
