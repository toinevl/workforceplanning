  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
        <h2 className="text-xl font-semibold text-red-900 mb-2">Failed to load scenario</h2>
        <p className="text-red-800 mb-6 text-sm">
          {error.message || 'An error occurred while loading the scenario. Please try again.'}
        </p>
